...
description: "OpenClaw: Feishu/Lark approval v4 via feishu-approval-tool. docs/AI.md; approval-code-map.local.md first (gitignored; util init copies example), else approval-code-map.md; §7 fieldList/date/formula; util scaffold/extract/validate/form-string/doctor/init; task reject --task-ids|--batch-json-file; task search --pending-only|--task-status; instance create --wizard|--template expense; Feishu code≠0 → stderr hints. Triggers: 飞书审批, Lark approval, approval_code, instance_code, 抄送, 加签, 订阅."
---
